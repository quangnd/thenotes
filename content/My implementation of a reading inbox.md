---
aliases:
  - Cách tôi triển khai hộp thư đọc
---

Ghi chú này mô tả hệ thống triển khai [[A reading inbox to capture possibly-useful references|Hộp thư đọc để thu thập tài liệu tham khảo có thể hữu ích]].

Việc đọc có nhiều dạng, và các công cụ khác nhau phù hợp để ghi lại và đọc các loại phương tiện khác nhau, nhưng tôi "xử lý" tất cả các mục từ hộp thư đến này cùng một lúc. [[Inboxes shouldn't be split into multiple places|Hộp thư không nên chia thành nhiều nơi]], vì vậy tôi tạo một hộp thư đến "ảo" trình bày một lớp thống nhất trên các mục này.
...
Tôi đọc e-book trong Clearview, nhưng tôi ghét nó (xem [[All desktop EPUB readers are awful|Tất cả trình đọc EPUB trên máy tính để bàn đều tệ]]).
