...
Các thí nghiệm về [[Span of absolute judgment|Phạm vi phán đoán tuyệt đối]] của con người có thể được dùng để mô hình hóa con người theo cách này. Tổng quan của Miller (1956) về dữ liệu thực nghiệm gợi ý rằng dung lượng kênh của con người cho các kích thích đơn chiều là khoảng {2,6} bit.
