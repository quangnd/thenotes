---
aliases:
  - Mở rộng quy mô sớm có thể cản trở việc lặp lại hệ thống
---
...
Một lợi thế lớn của việc mở rộng quy mô là bạn sẽ nhận được nhiều phản hồi hơn cho quá trình [[Insight through making|Hiểu biết sâu sắc qua việc làm]] của mình. Đúng là [[Effective system design requires insights drawn from serious contexts of use|Thiết kế hệ thống hiệu quả cần insight từ bối cảnh sử dụng thật]], nhưng có thể tạo ra các bối cảnh sử dụng nghiêm túc quy mô nhỏ cho phép bạn trả lời nhiều câu hỏi cốt lõi về hệ thống. Thực tế: các nhà công nghệ thường bản năng mở rộng quy mô hệ thống để tăng cơ hội nhận được phản hồi mạnh mẽ từ người dùng nghiêm túc, nhưng đó là cách tiếp cận khá ngẫu nhiên. Bạn có thể đạt được mục tiêu đó bằng cách cấu trúc cẩn thận quá trình tạo nguyên mẫu. Điều này có thể tốt hơn cuối cùng vì [[Insight through making prefers bricolage to big design up front|Hiểu biết thông qua việc tạo ra ưu tiên bricolage hơn thiết kế lớn từ đầu]]
