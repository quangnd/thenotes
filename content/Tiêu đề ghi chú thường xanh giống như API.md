...
Vài kỹ thuật "thiết kế API" cho ghi chú: tách biệt mối quan tâm ([[Ghi chú thường xanh nên atomic]]), tiêu đề sắc nét ([[Ưu tiên tiêu đề ghi chú dạng cụm hoàn chỉnh để làm sắc luận điểm]]), và cách đặt vấn đề tích cực ([[Ưu tiên tiêu đề ghi chú tích cực để xây lý thuyết có hệ thống]]).
