...
Một cuốn sách nền tảng về cách làm [[MOC Hệ thống viết ghi chú|hệ thống viết ghi chú]]. Sönke tập trung chủ yếu vào lợi ích của Zettelkasten đối với quy trình viết học thuật. Một trong những ý tưởng cốt lõi: viết sáng tạo có thể được đóng khung rõ hơn và biến thành việc có thể hành động. Theo kiểu GTD, nó có thể được thực thi qua một chuỗi bước dựa trên hệ thống ghi chú liên kết dày đặc.

---

### Lời khuyên về liên kết

Từ khóa nên ít và được chọn lọc cẩn thận. Chúng chủ yếu là điểm "nhảy vào". Các kết nối giữa ghi chú mới là phương tiện điều hướng chính. [[Tài liệu tham khảo được lập chỉ mục so với thẻ|Lập chỉ mục tài liệu tham khảo so với dùng thẻ]], [[Thẻ là cấu trúc liên kết kém hiệu quả]]
- Đảm bảo có thể tìm lại ghi chú này sau, bằng cách liên kết đến nó từ chỉ mục, hoặc tạo liên kết đến nó trên một ghi chú đóng vai trò điểm vào cho một chủ đề và bản thân ghi chú đó được liên kết từ chỉ mục.
- Trong Zettelkasten, từ khóa có thể được thêm vào ghi chú như thẻ và sẽ hiển thị trong chỉ mục. Cần chọn thẻ cẩn thận và dùng ít. Luhmann thường thêm số của một hoặc hai ghi chú, hiếm khi nhiều hơn, bên cạnh từ khóa trong chỉ mục (Schmidt 2013, 171).
...
- Cách một người chọn từ khóa cho thấy rõ họ đang nghĩ như người lưu trữ hay như người viết. Họ tự hỏi nên cất ghi chú ở đâu, hay làm sao để tình cờ gặp lại nó? Người lưu trữ hỏi: Từ khóa nào phù hợp nhất? Người viết hỏi: Trong hoàn cảnh nào tôi sẽ muốn tình cờ gặp lại ghi chú này, kể cả khi đã quên nó? Đây là khác biệt then chốt.

Cần cẩn thận với liên kết tự động. [[Ưu tiên liên kết tường minh hơn liên kết suy luận|Ưu tiên liên kết tường minh hơn liên kết suy luận]]
...
Sau này, bạn sẽ nghĩ về "tác động của X lên Y", chứ không nghĩ theo kiểu một cuốn sách cụ thể có một luận điểm về chủ đề đó. Áp dụng [[Ghi chú thường xanh nên hướng khái niệm|cách ghi chú xoay quanh khái niệm]] giúp xây dựng cấu trúc tổ chức phản ánh các bối cảnh tương lai, nơi bạn muốn gặp lại những ý tưởng đã chắt lọc.
- Nhiều sinh viên và người viết học thuật nghĩ về ghi chú giống như các chủ tàu thời đầu. Họ xử lý ý tưởng và phát hiện theo cách thoạt nhìn có vẻ hợp lý: thấy câu hay thì gạch chân, có bình luận thì viết vào lề, có ý tưởng thì ghi vào sổ tay, bài viết quan trọng thì cố tóm tắt lại. Làm vậy để lại rất nhiều ghi chú rải rác khắp nơi. Khi viết, họ phải dựa vào bộ não để nhớ đã ghi cái gì ở đâu, khi nào. Văn bản sau đó phải hình thành tách rời khỏi các ghi chú này. Đó là lý do nhiều người phải dùng động não để sắp xếp tài liệu theo ý tưởng có sẵn.
...
Thẻ ghi nhớ cần được diễn giải đủ chi tiết và đặt trong bối cảnh.
- Thông tin trên thẻ ghi nhớ thường không được diễn giải đủ chi tiết, cũng không nằm trong bối cảnh nào. Mỗi thẻ ghi nhớ bị cô lập, không kết nối với mạng lưới khung lý thuyết, trải nghiệm, hay mô hình tư duy của chúng ta.

[[Duy trì ghi chú thường xanh tương tự lặp lại ngắt quãng|Duy trì ghi chú thường xanh giống như ôn tập lặp lại ngắt quãng]], nhưng trong bối cảnh tự nhiên hơn.
...
- "Chọn lọc chính là xương sống mà trên đó con tàu tinh thần của chúng ta được xây dựng. Và trong trường hợp trí nhớ, tính hữu ích của nó là hiển nhiên. Nếu chúng ta nhớ mọi thứ, trong hầu hết các trường hợp chúng ta sẽ tồi tệ như khi không nhớ gì. Sẽ mất nhiều thời gian để nhớ lại một khoảng thời gian bằng khoảng thời gian ban đầu đã trôi qua, và chúng ta sẽ không bao giờ tiến lên được với suy nghĩ của mình." (William James 1890, 680).

### Ghi chú giúp suy nghĩ chính xác
Viết trong khi đọc là cách tuyệt vời để theo dõi mức độ hiểu. Rất khó tóm tắt thứ mình không hiểu. Bước tiếp theo, tạo liên kết và tích hợp đoạn vừa viết với các ghi chú trước đó, càng làm hiệu ứng này mạnh hơn. [[Viết buộc ta phải hiểu vấn đề sắc bén hơn|Viết buộc ta hiểu vấn đề rõ và sâu hơn]]
...
Zettelkasten trung thực hơn về mặt nhận thức, và có khả năng giúp ta tìm ra những sự thật đi ngược kỳ vọng. [[Ghi chú thường xanh là nơi an toàn để nuôi ý tưởng táo bạo]], [[Viết buộc ta phải hiểu vấn đề sắc bén hơn|Viết buộc ta hiểu vấn đề rõ và sâu hơn]]
...
Rất khó thấy điều *không* được nói trong một văn bản. Bằng cách tích hợp các quan sát khi đọc với ghi chú trước đó, ta tự nhiên đối mặt với những góc mà tác giả có thể chưa xét tới. [[Viết buộc ta phải hiểu vấn đề sắc bén hơn|Viết buộc ta hiểu vấn đề rõ và sâu hơn]]
...
Viết ghi chú có vẻ tốn thời gian, nhưng đó là khi so với một chuẩn so sánh tưởng tượng. Đọc *mà không* ghi chú thường là *hoàn toàn* lãng phí thời gian. [[Viết ghi chú thường xanh giúp nỗ lực đọc tích lũy]]
...
Động não là một cái nạng.
- Vì việc ghi chú đúng cách hiếm khi được dạy hoặc bàn đến, không lạ gì khi hầu hết hướng dẫn viết đều khuyên bắt đầu bằng động não. Nếu chưa viết gì dọc đường, bộ não thực sự là nơi duy nhất để quay về. Tự nó, đó không phải lựa chọn tuyệt vời: nó không khách quan, cũng không đáng tin cậy. Đây là hai phẩm chất khá quan trọng trong viết học thuật hoặc phi hư cấu. Việc đề cao động não như điểm khởi đầu càng đáng ngạc nhiên hơn vì nó không phải nguồn gốc của hầu hết ý tưởng. Những thứ bạn được kỳ vọng tìm thấy trong đầu khi động não thường không sinh ra từ đó. Chúng đến từ bên ngoài: từ đọc, thảo luận và lắng nghe người khác.
- Nhiều sinh viên và người viết học thuật nghĩ về ghi chú giống như các chủ tàu thời đầu. Họ xử lý ý tưởng và phát hiện theo cách thoạt nhìn có vẻ hợp lý: thấy câu hay thì gạch chân, có bình luận thì viết vào lề, có ý tưởng thì ghi vào sổ tay, bài viết quan trọng thì cố tóm tắt lại. Làm vậy để lại rất nhiều ghi chú rải rác khắp nơi. Khi viết, họ phải dựa vào bộ não để nhớ đã ghi cái gì ở đâu, khi nào. Văn bản sau đó phải hình thành tách rời khỏi các ghi chú này. Đó là lý do nhiều người phải dùng động não để sắp xếp tài liệu theo ý tưởng có sẵn.

Kho ghi chú là nơi an toàn cho những linh cảm chưa thành hình phát triển.
- Steven Johnson, tác giả một cuốn sách sâu sắc về cách con người trong khoa học và đời thường nảy ra ý tưởng mới, gọi nó là "linh cảm chậm". Để khai thác trực giác này, ông nhấn mạnh tầm quan trọng của không gian thử nghiệm, nơi ý tưởng có thể tự do hòa trộn (Johnson 2011). Một phòng thí nghiệm với các đồng nghiệp cởi mở có thể là không gian như vậy, giống như giới trí thức và nghệ sĩ tự do thảo luận ý tưởng trong các quán cà phê Paris cũ. Tôi muốn thêm hộp phiếu vào danh sách: một không gian nơi ý tưởng tự do hòa trộn để sinh ra ý tưởng mới.

### Tinh thần khi viết
Cách làm ghi chú có thể biến việc viết thành một quy trình dự đoán được và có thể hành động ("bắt đầu từ sự dồi dào"). [[Chiến lược thực thi cho việc viết|Chiến lược biến việc viết thành hành động cụ thể]]
...
Zettelkasten là van xả áp rất tốt cho việc biên tập. Tài liệu không thiết yếu cho một tác phẩm cụ thể vẫn có thể trở thành ghi chú lâu dài và sinh giá trị sau này. Ngược lại, nếu việc viết *bắt đầu* từ kho ghi chú, xóa tài liệu khỏi bản thảo cũng không hại gì vì nó vẫn tồn tại ở nơi khác. [[Ghi chú thường xanh làm giảm áp lực cảm xúc khi chỉnh sửa bản thảo]]
...
Ghi chú là cách tập trung vào "đầu vào, không phải đầu ra", và không chỉ về mặt thời gian. [[Chiến lược thực thi cho việc viết|Chiến lược biến việc viết thành hành động cụ thể]], [[Viết ghi chú thường xanh là đơn vị cơ bản của công việc tri thức]]
