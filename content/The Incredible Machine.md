...
Hộp công cụ hạn chế đôi khi được sử dụng để làm cho các cấp độ thêm thách thức, nhưng chủ yếu là để giảm độ phức tạp không giới hạn và làm cho cấp độ có thể giải được ([[Ràng buộc như một cấu trúc hỗ trợ việc học]]). Các cấp độ được sắp xếp theo thứ tự để giới thiệu từng phần theo thời gian, dần dần kết hợp chúng trong các tổ hợp ngày càng phức tạp hơn: [[Các tiến trình nhiệm vụ chi tiết như là bộ khung nhận thức]].

![](Attachments/the-incredible-machine-6.png)
