...
- Ta học được điều gì đó không chỉ khi kết nối nó với kiến thức đã có và cố hiểu các hàm ý rộng hơn (mở rộng, elaboration), mà còn khi cố truy xuất nó ở các thời điểm khác nhau (giãn cách, spacing), trong các bối cảnh khác nhau (biến đổi, variation), lý tưởng là có thêm yếu tố ngẫu nhiên (can thiệp bối cảnh, contextual interference) và nỗ lực có chủ đích (truy xuất, retrieval). Hộp phiếu không chỉ cho ta cơ hội học theo cách đã được kiểm chứng này, nó còn buộc ta làm đúng những gì được khuyến nghị, chỉ bằng việc sử dụng nó. (We learn something not only when we connect it to prior knowledge and try to understand its broader implications (elaboration), but also when we try to retrieve it at different times (spacing) in different contexts (variation), ideally with the help of chance (contextual interference) and with a deliberate effort (retrieval). The slip-box not only provides us with the opportunity to learn in this proven way, it forces us to do exactly what is recommended just by using it.)
