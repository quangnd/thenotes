...
[[The mnemonic medium can help readers apply what they’ve learned through simple application prompts|Phương tiện ghi nhớ có thể giúp người đọc áp dụng những gì đã học qua prompt ứng dụng đơn giản]]. Loại prompt này chia sẻ nhiều đặc điểm với prompt gợi nhớ hiện tại của chúng tôi.
...
- Hưởng lợi từ [[Spacing effect|Hiệu ứng ngắt quãng]] (dù lịch trình có thể khác).
- "Tiến bộ" mô tả hợp lý là "trả lời đúng liên tục với khoảng cách không học ngày càng dài".
- Dù [[Application prompts should vary when repeated|Prompt ứng dụng nên thay đổi khi lặp lại]], các biến thể đó vẫn gom được vào một thực thể "câu hỏi" hoặc "bài tập" đơn lẻ, tích lũy tiến bộ khi từng phần được hoàn thành.
...
Vì trải nghiệm của hai loại prompt này có nhiều điểm chung, các giải pháp thiết kế cho prompt gợi nhớ phần lớn cũng dùng được cho prompt ứng dụng đơn giản. Tức là prompt ứng dụng đơn giản có thể đưa vào môi trường ôn tập sẵn có của [[Spaced repetition memory system|Hệ thống ghi nhớ lặp lại ngắt quãng]] mà không cần chỉnh sửa nhiều.

#### Khác biệt chức năng so với prompt gợi nhớ

Nhìn từ góc độ hệ thống, prompt ứng dụng khác prompt ghi nhớ ở vài điểm.

- Hệ thống nên trình bày cặp câu hỏi/câu trả lời khác nhau mỗi lần ([[Application prompts should vary when repeated|Prompt ứng dụng nên thay đổi khi lặp lại]]), gom trong một thực thể "câu hỏi" hoặc "bài tập" đơn lẻ tích lũy tiến bộ.
...
Dù khác biệt chức năng tương đối nhỏ, các prompt này buộc chúng tôi phải đổi cách mô tả [[Mnemonic medium|Phương tiện ghi nhớ]], cách đóng khung lời kêu gọi hành động, cách kể về tiến bộ, v.v.
