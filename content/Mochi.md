...
Thật không may, sự tích hợp giữa hệ thống ghi nhớ lặp lại ngắt quãng và các ghi chú không liền mạch. "Tạo thẻ từ ghi chú" là một thao tác thủ công, không idempotent. Nếu bạn thêm một thẻ mới vào ghi chú, sau đó nhấp lại vào nút "tạo thẻ từ ghi chú", nó sẽ tạo ra thẻ trùng lặp. Thẻ trùng lặp sẽ không có trạng thái; nó sẽ được coi là "chưa học."
