...
Động não với người khác tạo ra một bối cảnh xã hội linh hoạt để trao đổi ý tưởng. Nhưng khi động não một mình, ta đang tạo ra một không gian mở rộng để gọi về những gì mình "gần như đã biết". Trong không gian đó, các ý tưởng có được chủ yếu bị giới hạn bởi tư duy và ý tưởng đã có từ trước (xem [[Leaps of insight emerge from prior thought|Những bước nhảy hiểu biết sâu sắc nảy sinh từ tư duy trước đó]]).

Tâm thế sinh tạo, không phán xét của một buổi động não đôi khi cho kết quả bất ngờ. Nhưng phần lớn ta dùng động não như cách thực dụng để dồn hết ý tưởng về một chủ đề vào cùng một chỗ. Đó có thể là dấu hiệu cho thấy hệ thống tri thức của mình chưa được thiết kế theo hướng [[Knowledge work should accrete|Công việc tri thức nên tích lũy]]. Với [[Evergreen notes|Ghi chú thường xanh]] và cấu trúc liên kết dày đặc (xem [[Evergreen notes should be densely linked|Ghi chú thường xanh nên liên kết dày đặc]]), các ý tưởng được thu thập và chắt lọc liên tục. [[Evergreen note-writing helps insight accumulate|Viết ghi chú thường xanh giúp tích lũy hiểu biết sâu sắc]], nên nhu cầu động não giảm hẳn, vì những hiểu biết đó đã xuất hiện và được ghi lại đều đặn trong công việc thường ngày.

Xem thêm: [[Evergreen notes are a safe place to develop wild ideas|Ghi chú thường xanh là nơi an toàn để nuôi ý tưởng táo bạo]]
