...
Sau khi thu thập, mỗi mục trong hộp thư sẽ rơi vào một trong các trạng thái:

1. bị xóa (xem lại thấy không đáng đọc kỹ)
2. được đọc nghiêm túc (tức là [[Write about what you read|Viết về thứ mình đọc]])
3. được đọc lướt và lưu vào thư viện tham khảo
4. (có thể) được thêm vào danh sách khác như "công thức cần nấu"

Quan trọng: đây không phải danh sách "một ngày nào đó". Nó không tích lũy vô hạn, vì nếu vậy nó sẽ không còn là cách đáng tin cậy để [[Close open loops|Đóng các vòng lặp còn mở]].
...
Thú vị là không có hệ thống "đọc sau" hay quản lý tham chiếu nào hiện nay đáp ứng được các tiêu chí này. Chúng thường bị tách theo loại nội dung, và không hệ thống nào khuyến khích loại bỏ các mục tồn đọng. Xem thêm: [[Beware automatic import into the reading inbox|Cẩn thận khi tự động đưa vào hộp thư đọc]].

Hộp thư đọc là van xả quan trọng cho những thứ tôi gặp khi dùng điện thoại (xem [[Use phones to collect and triage, not (usually) to read|Dùng điện thoại để thu thập và phân loại, không phải để đọc]]).

Liên quan: [[Incremental reading|Đọc tăng dần]]
